...
CREATE TABLE `tbl_client_orders` (
  ...
  `minlevel` varchar(500) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `maxlevel` varchar(500) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `reorderlevel` varchar(500) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `qtytoorder` varchar(500) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `lot_name` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
